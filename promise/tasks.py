...
#     # # promise_amount_after_charges = Decimal(str(charges_amount)) * Decimal('0.02')

#     # if fulfilled_promises.is_settle_conflict_activated == True:
#     #     promise_amount = fulfilled_promises.amount
#     #     charges_percentage = Decimal('0.02')
#     #     charges_amount = promise_amount * charges_percentage
#     #     promise_amount_after_charges = promise_amount - charges_amount
