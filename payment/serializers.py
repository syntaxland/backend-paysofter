...
class PaymentLinkSerializer(serializers.ModelSerializer):
    ...
    # seller_business_name = serializers.CharField(source='seller.seller_business_name', read_only=True)
    # seller_logo = serializers.CharField(source='seller.seller_logo', read_only=True) 
