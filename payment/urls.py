...
urlpatterns = [
    ...
    path('update-payment-link/', views.update_payment_link, name='update_payment_link'),
    path('delete-payment-link/', views.delete_payment_link, name='delete_payment_link'),
